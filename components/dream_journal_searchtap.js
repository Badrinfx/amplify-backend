...
let newData=this.state.dreamTitleTemp.filter(item=>{
 ...
 this.setState({txt:txt,pageTitle:"Dream Search",newData:newData})
 
}
onpressfunc=()=>{
    this.setState({pageTitle:"Dream Search",dreamTitle:this.state.newData})
}
...
{/* </View> */}
 ...
 searchicon: {
 marginLeft:80,marginTop:5,marginBottom:5, width:'5%',height:'5%'
 },
