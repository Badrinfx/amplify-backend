...
const awsmobile = {
  ...
  "aws_appsync_apiKey": "da2-nsdi3lyswbecbnao32nzmmxhay",
...
export default class Dreams extends React.Component {
    ...
    constructor(props){
           super(props)
           this.state = {dreams:[],title: "", desc :"",textBgColor: '#F4F5F6',textColor:'#000000',compvalcalled : false,text:"" ,Category:"",maxfilelength: 1, editMode : true,sampleText:"Save",fid:0,existingfid:false ,isDreamPrivate:"false"}
