...
export default class App extends React.Component {
    ...
    constructor(props){
           super(props)
           this.state = {dreams:[],result:[],title: "", desc :"",textBgColor: '#F4F5F6',textColor:'#000000',compvalcalled : false,text:"" ,Category:"",maxfilelength: 1, editMode : true,sampleText:"Save",fid:0,existingfid:false ,isDreamPrivate:"false",forDre:[]}
...
//           selectedStartDate,selectedState,selectedCountry,City,fid} = this.state
//         let input ={
//           dreamtitle:title,
//           dreamid:fid,
  ...
  return (<React.Fragment></React.Fragment>);
    ...
    return(
      ...
      <TextInput
        ...
        editable={this.state.editMode}
      />
{/* <TouchableHighlight style={{alignItems:"center",justifyContent: 'center',height:50,width:50}} onPress={this.getNewID}><Text>get uuid</Text></TouchableHighlight> */}
